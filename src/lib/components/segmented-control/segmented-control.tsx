...
export const SegmentedControl: React.FC<SegmentedControlProps> = ({
  ...
  const variantClasses = {
    default: 'bg-secondary hover:bg-secondary/80 [&>.indicator]:bg-white [&>.indicator]:shadow-sm',
    material: 'bg-secondary/50 hover:bg-secondary/80 [&>.indicator]:bg-primary [&>.indicator]:shadow-none',
    ios: 'bg-secondary/80 backdrop-blur-sm [&>.indicator]:bg-white [&>.indicator]:shadow-md',
  }
  ...
  return (
    ...
    >
      <div className="indicator absolute z-0 rounded-md transition-all duration-200 ease-out" style={indicatorStyle} />
      ...
      {options.map((option) => (
        <button
          ...
          className={cn(
            ...
            variant === 'default' && selectedValue === option.value && 'text-primary',
            variant === 'material' && selectedValue === option.value && 'text-primary-foreground',
            variant === 'ios' && selectedValue === option.value && 'text-muted-foreground',
